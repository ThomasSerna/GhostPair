...
export function NewTabDialog({ onClose, controlRevision }: { onClose: () => void; controlRevision: number }) {
  ...
  async function open() {
    ...
    try { await request('ui.command', { command: { type: 'tab.create', url: normalized, controlRevision } }); onClose(); }
